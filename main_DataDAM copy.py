    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
            ...
            for layer in range(length_of_network-1):
                ...
                real_attention = get_attention(original_model_set_activations[layer].detach(), param=1, exp=4, norm='l2')
                syn_attention = get_attention(syn_model_set_activations[layer], param=1, exp=4, norm='l2')
